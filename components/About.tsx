export default function About() {
    return (
      <section id="about" className="py-20  py-20 bg-gray-100 dark:bg-gray-800">
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg mb-4 text-gray-800 dark:text-white">
              I&apos;m passionate about [Your Interests in Tech], and I&apos;m always eager to learn new technologies 
              and improve my skills.
            </p>
            <p className="text-lg text-gray-800 dark:text-white">
              When I&apos;m not coding, you can find me [Your Hobbies or Interests Outside of Coding].
            </p>
          </div>
        </div>
      </section>
